...
function draw() { //code that runs constantly
  ...
  if (begin == true) {
    ...
    if (vol > 0.04) { //when volume microphone higher than ...
      start = true;
    ...
    if (sensortimer == 0) {
      if (p < 1) {
        ...
        $.ajax({ //to send data to the database
          url: 'https://data.id.tue.nl/datasets/entity/434/item/',
          headers: {
    ...
    if (meetingbutton == true && mouseX > 540 && mouseX < 700 && mouseY > 240 && mouseY < 290 && mouseIsPressed == true) {
      //pressed base color button 1
      B1C1S1 = 130;
      B1C2S1 = 190;
      B1C3S1 = 255;
    ...
    if (meetingbutton == true && mouseX > 540 && mouseX < 700 && mouseY > 240 && mouseY < 290 && mouseIsPressed == false) {
      //hover base color button 1
      B1C1S1 = 140;
      B1C2S1 = 200;
      B1C3S1 = 255;
